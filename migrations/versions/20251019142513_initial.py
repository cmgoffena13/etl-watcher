...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "address_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("parent_execution_id", sa.BigInteger(), nullable=False),
        sa.Column("child_execution_id", sa.BigInteger(), nullable=False),
        sa.Column("depth", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["child_execution_id"],
            ["pipeline_execution.id"],
